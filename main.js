...
numbersE1.forEach( number => {
    number.addEventListener('click', (e)=> {
        // if we click the dot on the calculator and we have a dot in our number the case is true if not return the number if it is not.
...
// in every number we have, if any number in .innertext = .key
